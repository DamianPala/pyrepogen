...
REPOASSIST_FILES = [
    ...
    RepoassistFileGenEntry(src=Path(FileName.SICLOUDMAN), dst=Path('.') / DirName.REPOASSIST / FileName.SICLOUDMAN, is_templ=False),
    ...
    RepoassistFileGenEntry(src=Path(FileName.RELTOOLS), dst=Path('.') / DirName.REPOASSIST / FileName.RELTOOLS, is_templ=False),
    ...
    RepoassistFileGenEntry(src=Path(DirName.TEMPLATES) / f'{FileName.CHANGELOG_PREPARED}{JINJA2_TEMPLATE_EXT}', 
                           ...
                           is_templ=False),
    RepoassistFileGenEntry(src=Path(DirName.TEMPLATES) / f'{FileName.AUTHORS_GENERATED}{JINJA2_TEMPLATE_EXT}', 
                           dst=Path('.') / DirName.REPOASSIST / DirName.TEMPLATES / f'{FileName.AUTHORS_GENERATED}{JINJA2_TEMPLATE_EXT}', 
                           is_templ=False),
